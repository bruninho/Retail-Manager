...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { end_date: @special.end_date, start_date: @special.start_date, title: @special.title }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { end_date: @special.end_date, start_date: @special.start_date, title: @special.title }
    assert_redirected_to special_path(assigns(:special))
  end
